...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: exp  */
#line 10 "2018047_OEL_2.y"
           {printf("%d\n",yyval);}
#line 1111 "y.tab.c"
    break;

  case 3: /* exp: exp '+' exp  */
#line 12 "2018047_OEL_2.y"
              {yyval=yyvsp[-2]+yyvsp[0];}
#line 1117 "y.tab.c"
    break;

  case 4: /* exp: exp '-' exp  */
#line 13 "2018047_OEL_2.y"
               {yyval=yyvsp[-2]-yyvsp[0];}
#line 1123 "y.tab.c"
    break;

  case 5: /* exp: exp '*' exp  */
#line 14 "2018047_OEL_2.y"
               {yyval=yyvsp[-2]*yyvsp[0];}
#line 1129 "y.tab.c"
    break;

  case 6: /* exp: exp '/' exp  */
#line 15 "2018047_OEL_2.y"
                { 
                    if(yyvsp[0]==0) 
                        yyerror("error"); 
                    else 
...
#line 1142 "y.tab.c"
  ...
  case 7: /* exp: '(' exp ')'  */
#line 24 "2018047_OEL_2.y"
               {yyval=yyvsp[-1];}
#line 1148 "y.tab.c"
    break;

  case 8: /* exp: NUM  */
#line 25 "2018047_OEL_2.y"
         {yyval=yyvsp[0];}
#line 1154 "y.tab.c"
    break;
